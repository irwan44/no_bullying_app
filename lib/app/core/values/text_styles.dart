...
final greyDarkContentTextStyle = greyDarkTextStyle.copyWith(fontSize: 12);

const contentTextStyle = TextStyle(fontSize: 12,
    fontWeight: FontWeight.w400,
...
final boldTitleNeutralColorStyle =
    boldTitleStyle.copyWith(color: AppColors.neutral400);
